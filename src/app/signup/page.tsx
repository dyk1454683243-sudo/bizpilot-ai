...
export default function SignupPage() {
  ...
  const features = [
    { icon: <Sparkles className="h-5 w-5" />, text: 'AI-powered lead scoring & follow-ups' },
    { icon: <TrendingUp className="h-5 w-5" />, text: 'Smart revenue analytics & forecasting' },
    { icon: <Shield className="h-5 w-5" />, text: 'Secure data with end-to-end encryption' },
    { icon: <Zap className="h-5 w-5" />, text: 'Set up in under 5 minutes' },
  ];
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] gradient-hero relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 py-12 w-full">
          ...
          <div className="flex items-center gap-2 mb-12">
            ...
            <span className="text-2xl font-bold text-white">BizPilot</span>
          ...
          <h1 className="text-4xl xl:text-5xl font-extrabold text-white leading-tight mb-4">
            Start growing your
            <br />
            <span className="text-indigo-200">business today</span>
          </h1>
          <p className="text-lg text-indigo-200 mb-10 max-w-md">
            Join thousands of Indian businesses using AI to convert leads, automate follow-ups, and grow revenue.
          </p>
          ...
          {/* Testimonial */}
          <div className="mt-14 p-5 rounded-xl bg-white/10 backdrop-blur border border-white/10 max-w-md">
            <p className="text-sm text-white/90 italic mb-3">
              &ldquo;BizPilot AI helped me convert 40% more leads in just one month. The AI follow-ups are a game changer!&rdquo;
            </p>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-indigo-200">Coaching Center Owner</p>
              </div>
            </div>
          </div>
        </div>
